...
const CollapseMenu = ({ title, header, items }) => {
    return (
    ...
    return (
        <div id="wrapper">
            ...
            >
                ...
                {/* <!-- Heading --> */}
                <div className="sidebar-heading">Immuto Examples</div>
                {/* <!-- Nav Item - Tables --> */}
                <NavItem path="/file-upload" text="File Upload" />
                ...
                <CollapseMenu title="Pages" header="Login Screens:" items={["Login", "Register", "404 Page"]}  />

                <NavItem path="/tables" text="Tables" />
